...
//sobrecarga es la capacidad de los diferentes metodos de una clase para nombrarse de la misma forma; 
public class animal {
    ...
    public animal(){
        ...
        //El nombre del contructor es el mismo que de la clase pero sin parametros
        //Es un metodo
    }
    public animal(String nom, String raz, String tipo_alimento, int edad){
            //constructor sobrecargado 
            //sirve para obtener el paso de cada parametro esto es necesario porque debemos de obtener el acceso a los atributos 
